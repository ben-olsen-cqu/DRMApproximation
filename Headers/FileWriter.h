...
public:
	...
	static void WriteCoordTree(std::string filename, Quadtree<Coordinates>* quad);
	static void WriteCoordTreeASC(std::string filename, const Quadtree<Coordinates>* quad);
